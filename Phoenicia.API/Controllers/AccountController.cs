...
using Phoenicia.API;
using Phoenicia.API.Controllers;
using Phoenicia.API.Infrastructure;
using Phoenicia.API.Models;
using Phoenicia.API.Services;
using CreateUserBindingModel = Phoenicia.API.Models.CreateUserBindingModel;
...
public class AccountsController : BaseApiController
{
    ...
    public async Task<IHttpActionResult> CreateUser(CreateUserBindingModel createUserModel)
    {
        ...
        var user = new ApplicationUser()
        {
            ...
            // PasscodeHash = TimeSensitivePassCode.GeneratePresharedKey(),
